...
and `1` for `-`. This is the same treatment as the [sign magnitute](_posts/demo/data_rep/2020-06-19-data-rep-int.md##sign-magnitude-原码).
- The _exponent_ part took 8 bits and used [_offset-binary (biased) form_](_posts/demo/data_rep/2020-06-19-data-rep-int.md#offset-binary-移码) to represent a signed integer. 
